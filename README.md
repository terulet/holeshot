...
**Juega:** https://terulet.github.io/holeshot/ · Reto diario: https://terulet.github.io/holeshot/#diario
...
- **GitHub Actions** (`.github/workflows/deploy.yml`): en cada push a `main`
  pasa las pruebas, publica la web en GitHub Pages y deja los tres paquetes
